...
public class CarrinhoPage extends BasePage {
    ...
    public boolean oProdutoApresentouQuantidadeEsperada(String nomeProduto, String quantidadeProdutoEsperado) {
		...
		boolean oProdutoApresentouQuantidadeEsperada = quantidadeProdutoEsperado.equals(quantidadeProduto.getAttribute("value"));
